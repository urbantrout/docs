...
Whenever you’re dealing with an [entry](/en/sections-and-entries.md) in your template, you’re actually working with an EntryModel object.
...
The ID of the entry’s [section](/en/sections-and-entries.md#sections).
